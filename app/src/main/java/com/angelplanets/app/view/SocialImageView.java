...
/**
 * 自定义社交页面的ImageView，能根据给定的图片比例，自动调整宽高，解决拉伸变形的屏幕适配问题
 * Created by yzh on 2016/3/13.
 */
public class SocialImageView extends ImageView {

    private float ratio; //图片宽高比例

    public SocialImageView(Context context) {
        super(context);
    }

    public SocialImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SocialImageView(Context context, AttributeSet attrs, int defStyleAttr) {
